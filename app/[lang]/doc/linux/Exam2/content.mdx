...
### Solution
Execute below given command to change the nice value to +10. But first check the PID of memcached process because you need the PID to change the nice value:
