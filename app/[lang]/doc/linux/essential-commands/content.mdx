...
- [Getting Started with Linux Essential Commands](#getting-started-with-linux-essential-commands)
  - [Read \& use system documentation](#read--use-system-documentation)
    - [섹션 별 의미](#섹션-별-의미)
  - [Package Manager](#package-manager)
    - [Repository update \& upgrade](#repository-update--upgrade)
    - [install](#install)
