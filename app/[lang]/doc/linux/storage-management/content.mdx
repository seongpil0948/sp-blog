...
### Mount 
리눅스에서 mount란 물리적인 장치를 파일 시스템의 일부로 연결하는 것을 의미합니다.  
```bash
...
│ │ ├─/sys/fs/cgroup/cpu,cpuacct cgroup  rw,nosuid,nodev,noexec,relatime,cpu,cpuacct
...
│ │ └─/sys/fs/cgroup/blkio cgroup  rw,nosuid,nodev,noexec,relatime,blkio
│ ├─/sys/fs/bpf   bpf    bpf    rw,nosuid,nodev,noexec,relatime,mode=700
...
```

### LVM(Logical Volume Manager)
물리적인 하드디스크를 논리적인 하드디스크로 나누어서 사용하는 기술입니다.
